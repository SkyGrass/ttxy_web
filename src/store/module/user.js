...
export default {
    ...
    mutations: {
        ...
        setUserRealName(state, realname) {
            state.userRealName = realname
        },
        setUserDept(state, userdept) {
            state.userDept = userdept
        },
        setUserEmpCode(state, empcode) {
            ...
            return new Promise((resolve, reject) => {
                try {
                    getUserInfo(state.token).then(res => {
                        ...
                        commit('setUserRealName', data.user_realname)
                        commit('setUserDept', data.user_dept)
                        ...
                        commit('setUserEmpCode', data.emp_code);
                        commit('setUserPwd', data.user_pwd);
                        resolve(data)
                    }).catch(err => {
                        reject(err)
                    })
