...
export default {
  ...
  mutations: {
    ...
    setcInvTree(state, cInvtree) {
      state.cInvtree = cInvtree;
    },
  ...
  actions: {
    ...
    initcInvTree({ state, commit }, cInvtree) {
      commit("setcInvTree", cInvtree);
    }
  }
};
